...
require('../lib/draftjs-editor.min.css');
...
var DraftJSEditor = function (_Component) {
  ...
  function DraftJSEditor(props) {
    ...
    _this.decorator = new _draftJs.CompositeDecorator([_link2.default]);
  ...
  _createClass(DraftJSEditor, [{
    ...
    value: function render() {
      ...
      var cleanObject = function cleanObject(object, keyArray) {
        var newObj = void 0;
        keyArray.forEach(function (x) {
          var deletedKey = object[x],
              otherKeys = _objectWithoutProperties(object, [x]);
      ...
      var passableProps = cleanObject(passedProps, ['content', 'customBlockControls', 'customBlocks', 'inlineControls', 'controlDisplay', 'containerStyle']);
